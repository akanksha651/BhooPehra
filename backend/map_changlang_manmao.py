...
UPDATES = [
    (67, 27.2494, 95.9550, "Manmao locality reference"),
    (68, 27.2494, 95.9550, "Manmao locality reference"),
    (69, 27.2494, 95.9550, "Manmao locality reference"),
]
...
try:
    ...
    db.commit()
    print("CHANGLANG_MANMAO_MAPPING_OK")
    print("MAPPED=3")
